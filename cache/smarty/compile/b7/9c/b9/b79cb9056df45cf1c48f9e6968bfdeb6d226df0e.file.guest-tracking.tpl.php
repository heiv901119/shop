<?php /* Smarty version Smarty-3.1.19, created on 2016-08-10 16:32:23
         compiled from "C:\xampp\htdocs\tiendita\themes\default-bootstrap\guest-tracking.tpl" */ ?>
<?php /*%%SmartyHeaderCode:977557ab3af7a5eef6-38071527%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b79cb9056df45cf1c48f9e6968bfdeb6d226df0e' => 
    array (
      0 => 'C:\\xampp\\htdocs\\tiendita\\themes\\default-bootstrap\\guest-tracking.tpl',
      1 => 1466020874,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '977557ab3af7a5eef6-38071527',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_57ab3af7b49538_17374173',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57ab3af7b49538_17374173')) {function content_57ab3af7b49538_17374173($_smarty_tpl) {?>
...
"><?php echo smartyTranslate(array('s'=>'Log in now.'),$_smarty_tpl);?>
</a></p>
	<?php } else { ?>
...
<?php }?><?php }?>" size="8" />
                    ...
                    <div class="text form-group">
                        ...
                        <input class="form-control" type="email" name="email" value="<?php if (isset($_GET['email'])) {?><?php echo htmlspecialchars($_GET['email'], ENT_QUOTES, 'UTF-8', true);?>
<?php } else { ?><?php if (isset($_POST['email'])) {?><?php echo htmlspecialchars($_POST['email'], ENT_QUOTES, 'UTF-8', true);?>
<?php }?><?php }?>" />
                    </div>
			<p>
