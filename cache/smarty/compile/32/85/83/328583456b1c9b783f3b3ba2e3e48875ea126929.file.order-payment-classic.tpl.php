<?php /* Smarty version Smarty-3.1.19, created on 2016-08-10 16:32:28
         compiled from "C:\xampp\htdocs\tiendita\themes\default-bootstrap\order-payment-classic.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1268457ab3afc710593-83320892%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '328583456b1c9b783f3b3ba2e3e48875ea126929' => 
    array (
      0 => 'C:\\xampp\\htdocs\\tiendita\\themes\\default-bootstrap\\order-payment-classic.tpl',
      1 => 1466020876,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1268457ab3afc710593-83320892',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_57ab3afc95a517_67366936',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57ab3afc95a517_67366936')) {function content_57ab3afc95a517_67366936($_smarty_tpl) {?>
...
<?php }?></td>
                    ...
                    <tr class="cart_total_voucher" <?php if ($_smarty_tpl->tpl_vars['total_discounts']->value==0) {?>style="display:none"<?php }?>>
                        <td colspan="4" class="text-right">
                            <?php if ($_smarty_tpl->tpl_vars['use_taxes']->value) {?>
                                <?php if ($_smarty_tpl->tpl_vars['priceDisplay']->value) {?>
                                    <?php if ($_smarty_tpl->tpl_vars['display_tax_label']->value&&$_smarty_tpl->tpl_vars['show_taxes']->value) {?><?php echo smartyTranslate(array('s'=>'Total vouchers (tax excl.)'),$_smarty_tpl);?>
<?php } else { ?><?php echo smartyTranslate(array('s'=>'Total vouchers'),$_smarty_tpl);?>
<?php }?>
                                <?php } else { ?>
                                    <?php if ($_smarty_tpl->tpl_vars['display_tax_label']->value&&$_smarty_tpl->tpl_vars['show_taxes']->value) {?><?php echo smartyTranslate(array('s'=>'Total vouchers (tax incl.)'),$_smarty_tpl);?>
<?php } else { ?><?php echo smartyTranslate(array('s'=>'Total vouchers'),$_smarty_tpl);?>
<?php }?>
                                <?php }?>
                            <?php } else { ?>
